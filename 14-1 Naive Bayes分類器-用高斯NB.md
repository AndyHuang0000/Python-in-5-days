# 14-1 Naive Bayes分類器-用高斯NB


### 用條件機率為基礎的分類方法.

#### 參考:http://scikit-learn.org/stable/modules/naive_bayes.html
...
## 3.執行結果
```
正確: [ 2.  1.  3.  2.  2.  1.  2.  3.  2.  3.  1.  1.  2.  3.  1.  3.  1.  2.
  3.  1.  3.  3.  3.  2.  2.  3.  1.  1.  3.  2.]
------------------------------------------------------------
預測: [ 2.  1.  2.  2.  2.  1.  2.  3.  3.  3.  1.  1.  2.  3.  1.  3.  1.  2.
  3.  1.  3.  3.  3.  2.  2.  2.  1.  1.  3.  2.]
------------------------------------------------------------
...
## 4.問題
```
(1) 在sklearn中的NB, 除了Gaussian Naive Bayes外, 還有Multinomial及Bernoulli, 試試它們的特性.
(2) 到 UCI dataset 下載不同資料集進行分類實驗, 觀察三種不同核心的分類效果.
```
